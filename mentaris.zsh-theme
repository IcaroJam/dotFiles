...
ZSH_THEME_GIT_PROMPT_COLOR=$fg[blue]
ZSH_THEME_GIT_PROMPT_ADDED="%{$GIT_PROMPT_COLOR%}ADD%{$reset_color%}"
ZSH_THEME_GIT_PROMPT_MODIFIED="%{$GIT_PROMPT_COLOR%}MOD%{$reset_color%}"
ZSH_THEME_GIT_PROMPT_DELETED="%{$GIT_PROMPT_COLOR%}DEL%{$reset_color%}"
ZSH_THEME_GIT_PROMPT_RENAMED="%{$GIT_PROMPT_COLOR%}REN%{$reset_color%}"
ZSH_THEME_GIT_PROMPT_UNMERGED="%{$GIT_PROMPT_COLOR%}UNM%{$reset_color%}"
ZSH_THEME_GIT_PROMPT_UNTRACKED="%{$GIT_PROMPT_COLOR%}UNT%{$reset_color%}"
